...
@section('content')
  ...
  <div class="container-fluid">
    ...
    <div class="row pb-4">
        <div class="col-lg-12">
            <h3>
              @if ( $songs_data['singers'] )   
              {{ $songs_data['singers']->name }} Songs
              @else
              No Singers
              @endif  
              </h3>
            <div class="bio-content">
             ...
             @if ( $songs_data['singers']->bio && $songs_data['singers']->bio != null )   
             {!! $songs_data['singers']->bio !!}          
              @endif  
    ...
    @if ( $songs_data['singers']->youtube_url !== NULL ||  !empty($songs_data['singers']->youtube_url) )
    <div class="row pt-4"> 
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Youtube : </strong>         
                <div> 
                    <iframe width="420" height="315" src="{{$songs_data['singers']->youtube_url}}" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
        </div>
      </div> 
